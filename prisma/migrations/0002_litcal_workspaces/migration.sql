...
-- AlterTable
ALTER TABLE "Case" ADD COLUMN "workspaceId" TEXT;
...
-- CreateIndex
CREATE INDEX "Event_workspaceId_startTime_idx" ON "Event"("workspaceId", "startTime");
...
-- AddForeignKey
ALTER TABLE "Case" ADD CONSTRAINT "Case_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;
