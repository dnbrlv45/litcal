...
import { Plus, CheckCircle2, Circle, Clock, AlertCircle, ChevronDown, ListTodo, Sparkles } from "lucide-react";
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center gap-2 mt-1.5">
          {task.isAutoGenerated && (
            <span className="flex items-center gap-1 text-xs px-1.5 py-0.5 rounded font-semibold bg-violet-50 text-violet-700">
